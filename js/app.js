(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-filling__slider")) {
            const listItems = document.querySelectorAll(".filling__menu-item");
            const sliderItems = document.querySelectorAll(".slider-filling__slide");
            let fillingSlider = new core(".slider-filling__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".filling .prev-button",
                    nextEl: ".filling .next-button"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
                ...
                on: {
                    init: function() {
                        for (let x = 0; x < listItems.length; x++) if (listItems[x].classList.contains("active")) {
                            let dataFilter = listItems[x].getAttribute("data-filter");
                            for (let s = 0; s < sliderItems.length; s++) {
                                sliderItems[s].classList.remove("show");
                                sliderItems[s].classList.add("hide");
                                if (sliderItems[s].getAttribute("data-item") == dataFilter) {
                                    sliderItems[s].classList.remove("hide");
                                    sliderItems[s].classList.add("show");
                                }
                            }
                        }
                    }
            ...
            fillingSlider.update();
            for (let i = 0; i < listItems.length; i++) listItems[i].addEventListener("click", (function() {
                for (let q = 0; q < listItems.length; q++) listItems[q].classList.remove("active");
 ...
 */
    ...
    da.init();
    const showMoreContent = document.querySelector("[data-showmore]");
